...
from transpyler import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('transpyler')
...
def main(args=None):
    """
    Called with ``python -m transpyler.tests``: run main test suite.
    """
    ...
    import transpyler.tests as test_module
