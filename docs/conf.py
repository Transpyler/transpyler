...
# The transpyler for content autogenerated by Sphinx. Refer to documentation
# for a list of supported languages.
#
# This is also used if you do content translation via gettext catalogs.
# Usually you set "transpyler" from the command line for these cases.
language = None
...
# A dictionary with options for the search transpyler support, empty by default.
